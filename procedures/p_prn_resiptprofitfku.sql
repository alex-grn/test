CREATE OR REPLACE FUNCTION p_prn_resiptprofitfku(date_to date) RETURNS void AS
$body$
DECLARE 
i_ident INTEGER ;
rec          record;
...
DELETE  from RESIPPROFITFKUBUF WHERE ident = i_ident; 
...
--просчет за декабрь 
 	...
 	INSERT INTO RESIPPROFITFKUBUF (ident,val3,val4,val5,val6,kbkinid)

...
$body$
 declare
  NID                      BIGINT = ID;											--ID яюёыхфэхщ чряшёш ђрсышіћ "аххёђ№ћ яюыѓїрђхыхщ"
  NUSERID                  BIGINT = UID;										--шфхэђшєшърішџ Сю№эр
  NLID                     BIGINT;  											--г№ютхэќ фюёђѓяр									
  BENEFITSPACKETS_ID       BIGINT;												--ID яюёыхфэхщ чряшёш ђрсышіћ "Яръхђћ №ххёђ№ют"
  FILE_XML                 XML;
  FILE_TEXT                TEXT;
  sql                      TEXT;
  DOW                      record;
  ...
  NTEMP                    numeric = 0;
  SNODE                    TEXT;
  FL					   BIGINT = 0;											-- 1-юјшсър, эю у№ѓчшь, 2-юјшсър эх у№ѓчшь
  SERRORS				   TEXT='';												--Ях№хьхээрџ фыџ эръюяыхэшџ юјшсюъ я№ш чру№ѓчъх №ххёђ№р
  SMESSAGE_ERR			   TEXT='';												--бююсљхэшх юс юјшсъх
  temp text; --ях№хьхээрџ фыџ юђырфъш
  REMARK_ID				   BIGINT;
  buff					   numeric[];
begin
  --яюыѓїрхь ID яюёыхфэхщ ёђ№юъш яръхђр №ххёђ№р
  ...
  if   TO_NUMBER(TO_CHAR(NOW(), 'dd'), '99') >= 11
        	or (select s.repmonth from BENEFITSPACKETS s where s.id = BENEFITSPACKETS_ID)::numeric != TO_NUMBER(TO_CHAR(NOW() - interval '1 month', 'mm'), '99') 
  			...
  			then
    	--ьрі 3684 фюсртшыш яюёых 1-юую їшёыр, ёђртшь эр№ѓјхэшх ё№юъют
  ...
  begin
    ...
    then
      delete from BENEFICIARIESREGISTERS S where S.ID = NID;
      TRETURN = 'Юјшсър: дрщы №ххёђ№р юђёѓђёђтѓхђ.';
      raise
        using MESSAGE = 'Юјшсър: дрщы №ххёђ№р юђёѓђёђтѓхђ.';
      return TRETURN;
    end if;
    begin
    ...
    exception
      when others then
        delete from BENEFICIARIESREGISTERS S where S.ID = NID;
        TRETURN = 'Юјшсър: Эхъю№№хъђэрџ ёђ№ѓъђѓ№р XML-єрщыр.';
        raise
          using MESSAGE = 'Юјшсър: Эхъю№№хъђэрџ ёђ№ѓъђѓ№р XML-єрщыр.';
        return TRETURN;
    end;
    if (select cast((xpath('name(/*)', file_xml))[1] as text)) not like 'benefit%' then raise using message = 'дю№ьрђ чру№ѓцрхьюую №ххёђ№р эх ёююђтхђёђтѓхђ. аххёђ№ эх чру№ѓцхэ!'; end if;
  exception
    when others then
  ...
  execute sql;
   ...
   GET STACKED DIAGNOSTICS   err_state = RETURNED_SQLSTATE,
    ...
    --я№ютх№ър эр юјшсъш тэѓђ№ш я№юіхфѓ№ћ p_reestr_parse_xml
...
if FL = 1 then
    ...
    tRETURN:='Юсэр№ѓцхэћ юјшсъш я№ш чру№ѓчъх!';
    return tRETURN;
end if;
FL:=0;
--  
    ...
    loop
      ...
      loop
        ...
        then
          --я№ютх№ър 
          begin
            temp := ' дШЮ: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col10::text,'')||' '||COALESCE(dow.col11::text,''); --сх№хь фрээћх эр ёыѓїрщ хёыш тючэшъэхђ юјшсър
            select S.ID
          ...
          exception
            when NO_DATA_FOUND then
              if DOW.FLAG = 1
              then
                /*return*/SERRORS := SERRORS||CHR(13)||'Фрээћх яю яюыѓїрђхыў яюёюсшџ (ѓърчћтрхђёџ дрьшышџ Шьџ Юђїхёђтю (я№ш эрышїшш), ёх№шџ ш эюьх№ фюъѓьхэђр, ѓфюёђютх№џўљхую ышїэюёђќ, эх яюфђтх№цфхэћ). аххёђ№ чру№ѓцхэ ё юјшсъющ.';
              fl:=1;
              end if;
              --
              begin
...
/*шёъыўїхэшџ*/     exception when others then
                        		  GET STACKED DIAGNOSTICS  
/*ъюяшь юјшсъш*/                  SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp;
                   end;
              --
            when TOO_MANY_ROWS then
              raise
                using MESSAGE = 'Эрщфхэћ фѓсышърђћ ъ№шђшїхёърџ юјшсър! ' || DOW.COL1 || ' ' || DOW.COL2 || ' ' || DOW.COL3;
          end;
        ...
        then
          ...
          exception
            when NO_DATA_FOUND then
              if DOW.FLAG = 1
              then
                /*return*/SERRORS := SERRORS||chr(13)|| 'Фрээћх яю №хсхэъѓ (ѓърчћтрхђёџ дрьшышџ Шьџ Юђїхёђтю (я№ш эрышїшш), ёх№шџ ш эюьх№ фюъѓьхэђр, яюфђтх№цфрўљхую єръђ №юцфхэшџ, фрђр №юцфхэшџ эх яюфђтх№цфхэћ). аххёђ№ чру№ѓцхэ ё юјшсъющ.';
              fl:=1;
              end if;
              ...
              exception when others then  
                         GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                  SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' дШЮ №хсхэър: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col6::text,'')||' '||COALESCE(dow.col7::text,'');
                       end;
   ...
   /*ъюяшь юјшсъш*/                  SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' дШЮ №хсхэър: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col6::text,'')||' '||COALESCE(dow.col7::text,'');
        ...
        then
          ...
          then
            TRETURN = 'б№хфэхфѓјхтющ фюѕюф їыхэют ёхьќш эх ёююђтхђёђтѓхђ рыую№шђьѓ №рёїхђр. аххёђ№ эх чру№ѓцхэ!';
            delete from BENEFICIARIESREGISTERS S where S.ID = NID;
            return TRETURN;
          end if;
          begin
          ...
          exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <familymembers>';
                     end; 
        ...
        then
          ...
          then
            TRETURN = 'б№хфэхфѓјхтющ фюѕюф їыхэют ёхьќш фюыцхэ сћђќ эх сюыќјх, їхь т 1,5 №рчр, №рчьх№р я№юцшђюїэюую ьшэшьѓьр ђ№ѓфюёяюёюсэюую эрёхыхэшџ. аххёђ№ эх чру№ѓцхэ!';
            delete from BENEFICIARIESREGISTERS S where S.ID = NID;
            return TRETURN;
          end if;
          begin
          ...
          exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <purpose>';
                     end;
        ...
        then
          /*if DOW.FLAG = 1 THEN													--я№ютх№ър хёђќ ыш яю їхыютхъѓ тћяырђр яюёюсшщ ъръ тћяырђр, шэрїх №ѓурхьёџ, эю тёх №ртэю у№ѓчшь
          	if (SELECT COUNT(*)
          ...
          END IF;*/
          begin
          --ушях№ёыюцэрџ я№ютх№ър яю ёѓььрь
                       --ёьюђ№шь хёђќ ыш чэрїхэшџ т тючт№рђх, фюяырђх, ѓфх№црэшш
                     	if dow.col7::numeric != 0 and dow.col7::numeric is not null 
                           ...
                           or dow.col13::numeric != 0 and dow.col13::numeric is not null then
                        	--шљхь чряшёш яю яюыѓїрђхыў, сћыш ыш тћяырђћ №рэхх
                            IF (
                            select COUNT(*)
                             ...
                             where s.paysum is not null
                               ...
                               and t.benefitsrecipientsid = BENEFITSRECIPIENTS_ID) = 0 THEN 
                                SERRORS := SERRORS||CHR(13)||'Яю '||temp||' тћяырђ эх юсэр№ѓцхэю. аххёђ№ чру№ѓцхэ ё я№хфѓя№хцфхэшх!';
                                FL:=1;
                             END IF;
                        end if; 
                     --
           if (dow.col4::numeric = 0 or dow.col4 is null) and (dow.col7::numeric = 0 or dow.col7 is null) and (dow.col10::numeric = 0 or dow.col10 is null)and (dow.col13::numeric = 0 or dow.col13 is null) THEN raise using message = 'Тёх ђхуш ё ёѓььрьш яѓёђћх!'; end if;
        ...
        exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <payment>';
                     end;
...
--ииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииии
                   ...
                   if dow.col13 = '' then dow.col13 := null;end if;
                	if dow.stable = 'BENEFITSRECIPIENTS' then
                      ...
                      exception when no_data_found then 
                        if dow.flag = 1 then /*return*/SERRORS := SERRORS||CHR(13)||'Фрээћх яю яюыѓїрђхыў яюёюсшџ (ѓърчћтрхђёџ дрьшышџ Шьџ Юђїхёђтю (я№ш эрышїшш), ёх№шџ ш эюьх№ фюъѓьхэђр, ѓфюёђютх№џўљхую ышїэюёђќ, эх яюфђтх№цфхэћ). аххёђ№ чру№ѓцхэ ё юјшсъющ.'; fl:=1; end if;                      
                        --
                        begin
   ...
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp;
                     ...
                     select s.id
                      ...
                      where trim(lower(COALESCE(s.lastname,''))) = lower(COALESCE(dow.col1,''))
                        ...
                        and s.benefitsrecipientsid = BENEFITSRECIPIENTS_ID;
                      exception when no_data_found then
                        if dow.flag = 1 then /*return*/SERRORS := SERRORS||CHR(13)||'Фрээћх яю №хсхэъѓ (ѓърчћтрхђёџ дрьшышџ Шьџ Юђїхёђтю (я№ш эрышїшш), ёх№шџ ш эюьх№ фюъѓьхэђр, яюфђтх№цфрўљхую єръђ №юцфхэшџ, фрђр №юцфхэшџ эх яюфђтх№цфхэћ). аххёђ№ чру№ѓцхэ ё юјшсъющ.'; fl:=1; end if;
                      --
                       begin
                        if dow.col9 is null then FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' дШЮ №хсхэър: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col6::text,'')||' '||COALESCE(dow.col7::text,'')||'. Юђёѓђёђтѓхђ ђху childNumber!'; end if;
                        if dow.col9::integer <=0 then FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' дШЮ №хсхэър: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col6::text,'')||' '||COALESCE(dow.col7::text,'')||'. Юїх№хфэюёђќ №юцфхэшџ №хсхэър эх ьюцхђ сћђќ <=0 шыш яѓёђющ!'; end if;
   ...
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS :=  SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' дШЮ №хсхэър: '||COALESCE(dow.col1,'')||' '||COALESCE(dow.col2,'')||' '||COALESCE(dow.col3,'')||' ёх№шџ ш эюьх№ фюъѓьхэђр: '||COALESCE(dow.col6::text,'')||' '||COALESCE(dow.col7::text,'');
                     ...
                     exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <benefitassignment>';
                     end;
                     ...
                     exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <payments>';
                     end;
                     ...
                     --
                      if (dow.col4::numeric = 0 or dow.col4 is null) and (dow.col7::numeric = 0 or dow.col7 is null) and (dow.col9::numeric = 0 or dow.col9 is null)and (dow.col11::numeric = 0 or dow.col11 is null) THEN raise using message = 'Тёх ђхуш ё ёѓььрьш яѓёђћх!'; end if;
                     ...
                     exception when others then
                        			GET STACKED DIAGNOSTICS  
   /*ъюяшь юјшсъш*/                 SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp||' ђху: <periodpayments>';
                     end;
...
/*ъюяшь юјшсъш*/                  SMESSAGE_ERR = MESSAGE_TEXT; FL:=2; SERRORS := SERRORS||CHR(13)||SMESSAGE_ERR||'@'||temp;
        ...
        then
          ...
          insert into BENEFIT02BASIS
            (UID, LID, BENEFIT02ID, DOCSZNRN, REGISTEREDDATE, DISMISSALNUMBER, DISMISSALDATE, DETAILSCERTDATE, DETAILSCERTNUM, DETAILSCERTMEDICALORG)
          values
                           ...
                           or dow.col11::numeric != 0 and dow.col11::numeric is not null then
                            ...
                            select COUNT(*)
                             ...
                             where s.paysum is not null
                               ...
                               and t.benefitsrecipientsid = BENEFITSRECIPIENTS_ID) = 0 THEN 
                                SERRORS := SERRORS||CHR(13)||'Яю '||temp||' тћяырђ эх юсэр№ѓцхэю. аххёђ№ чру№ѓцхэ ё я№хфѓя№хцфхэшхь!'; --ёђрђѓё я№хфѓя№хцфхэшх
                                FL:=1;
                             END IF;
                        end if; 
                     --
...
--иииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииии             
   end if; 
   if fl = 1 then
   		update BENEFICIARIESREGISTERS S set WRONGLOADING = SERRORS, STATUS = '03' where S.ID = NID;  
        return 'Эрщфхэћ эх ъ№шђшїхёъшх юјшсъш я№ш чру№ѓчъх. аххёђ№ чру№ѓцхэ ё я№хфѓя№хцфхэшхь!';     
   elsif fl = 2 then
        ...
        return 'Эрщфхэћ ъ№шђшїхёъшх юјшсъш я№ш чру№ѓчъх. аххёђ№ эх чру№ѓцхэ!';
   end if;    

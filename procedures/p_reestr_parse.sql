...
declare
   ...
   bufID	 bigint;
 begin
 --эютшэър ёючфрхь єрщы ё юјшсърьш
...
-- return 'test';
 ...
 insert into filebuffer(cid, code, tablename, filename, bfile) values (ident, 'BFILE', 'ErrorsProtocol', 'ErrorsProtocol.txt', P_SYSTEM_FILE_FROM_TEXT('')) returning filebuffer.id into bufID;
   ...
   if file_text is null  then
     ...
     tRETURN = 'Юјшсър: дрщы №ххёђ№р юђёѓђёђтѓхђ.'; update filebuffer s set bfile = P_SYSTEM_FILE_FROM_TEXT(tRETURN) where s.id = bufID;return tRETURN;
   end if;
   begin
   ...
   exception
     when others then
       delete from BENEFICIARIESREGISTERS s where s.id = (select max(x.id) from BENEFICIARIESREGISTERS x);
       tRETURN = 'Юјшсър: Эхъю№№хъђэрџ ёђ№ѓъђѓ№р XML-єрщыр.';update filebuffer s set bfile = P_SYSTEM_FILE_FROM_TEXT(tRETURN) where s.id = bufID;return tRETURN;
   end;
    ...
    for dow in (select * 
                ...
                loop
                   ...
                   if dow.col13 = '' then dow.col13 := null;end if;
                    ...
                    if dow.col7::numeric <> dow.col6::numeric / dow.col1::integer then tRETURN = 'б№хфэхфѓјхтющ фюѕюф їыхэют ёхьќш эх ёююђтхђёђтѓхђ рыую№шђьѓ №рёїхђр. аххёђ№ эх чру№ѓцхэ!'; update filebuffer s set bfile = P_SYSTEM_FILE_FROM_TEXT(ltrim(cfile||chr(13)||tRETURN,chr(13))) where s.id = bufID;
                     																delete from BENEFICIARIESREGISTERS s where s.id = (select max(x.id) from BENEFICIARIESREGISTERS x); 
                    ...
                    if dow.col3::numeric > 1.5 * nTEMP then tRETURN = 'б№хфэхфѓјхтющ фюѕюф їыхэют ёхьќш фюыцхэ сћђќ эх сюыќјх, їхь т 1,5 №рчр, №рчьх№р я№юцшђюїэюую ьшэшьѓьр ђ№ѓфюёяюёюсэюую эрёхыхэшџ. аххёђ№ эх чру№ѓцхэ!'; update filebuffer s set bfile = P_SYSTEM_FILE_FROM_TEXT(ltrim(cfile||chr(13)||tRETURN,chr(13))) where s.id = bufID;
                     																delete from BENEFICIARIESREGISTERS s where s.id = (select max(x.id) from BENEFICIARIESREGISTERS x); 
    																				/*return tRETURN;*/ end if;
...
--ииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииииии       
   ...
   if (select count(*) from filebuffer s where s.id = bufID and s.bfile = P_SYSTEM_FILE_FROM_TEXT('')) != 0 then delete from filebuffer s where s.id = bufID; else  delete from BENEFICIARIESREGISTERS s where s.id = (select max(x.id) from BENEFICIARIESREGISTERS x);  tRETURN:='Тючэшъыр юјшсър я№ш чру№ѓчъх №ххёђ№р!';  end if;
   return tRETURN;
 end;
$body$
LANGUAGE 'plpgsql'
